...
<html lang="en">
  ...
  <!--LOGIN AND SIGNUP END-->
    ...
    <div class="row" style="background-color: #000000">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 " style="border-right: 1px solid #FF0004; min-height: 1800px;">
        	...
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 heading "  >
   				<h1 class="text-center"><span class='glyphicon glyphicon-user' style='color:white'></span> My Questions</h1>
        	</div>
	...
	if(isset($_SESSION['username'])){
			...
			if($uname==$row["musername"]){
						
						echo	'<form action="delques 2.php" method="Post" onClick="confirm(\'Are you sure ? \')">
							<button type="submit" class=" btn btn-dangerx btn-lg" role="button" style="background-color:#FF5700; color:#000000" name="delete"  >Delete</button>
			...
			{
				echo	'<form action="delques.php" method="Post">
			 ...
			 echo "<div class='col-lg-12 col-md-12 col-sm-12 col-xs-12 ' ><h1 class='text-center' style='colour:white; font-size:20px;'>Please Login</h1></div>";
			}
