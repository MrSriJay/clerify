    ...
    <div class="row" style="background-color: #000000">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 " style="border-right: 1px solid #FF0004; min-height: 1800px;">
        	...
        	<div class="jumbotron heading">
			  <h1><span class='glyphicon glyphicon-question-sign' style='color:white'></span> Questions</h1>
        ...
        <?php 
			...
			$sql="SELECT SUBSTRING(question, 1,50) AS question,category,mname,post_date,musername,qid  FROM `questions` ORDER BY post_date DESC";
