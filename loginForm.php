  ...
  <div id="id01" class="login">
			  ...
			  <form class="login-content" action="login.php" method="post">
				<div class="imgcontainer">
			  	  <h1 class="text-center" style="color: red; font-weight: bolder"><span class=" glyphicon glyphicon-log-in"></span> Login</h1><br/><br/>
				  <img src="img/login.png" alt="Avatar" class="img-responsive" style="margin: auto">
				</div>
