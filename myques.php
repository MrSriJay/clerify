...
<html lang="en">
  ...
  <!--LOGIN AND SIGNUP END-->
	...
	if(isset($_SESSION['username'])){
			...
			$sql="SELECT SUBSTRING(question, 1,50) AS question,category,mname,post_date,musername,qid  FROM questions where  musername='$uname'";
			$result=$conn->query($sql);
            if($result->num_rows>0){
				while($row = $result->fetch_assoc())
				{
					echo
        	'<div class="col-lg-10 col-lg-push-1 col-md-10 col-md-push-1 col-sm-12 col-xs-12" style="margin-top: 20px;" >
						<div class="thumbnail" style="background-color: #1A1A1A ; border: 1px #930002 solid">
						  <div class="caption">
							...
							<form action="view ques2.php" method="Post">
