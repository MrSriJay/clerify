    ...
    <div class="row" style="background-color: #000000">
        <div class="col-lg-9 col-md-9 col-sm-12 col-xs-12 " style="border-right: 1px solid #FF0004; min-height: 1800px;">
        	<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 heading "  >
   				<h1 class="text-center"><span class='glyphicon glyphicon-search' style='color:white'></span> Search Results</h1>
        	</div>
        <div class="row">
        ...
        <?php 
			...
			$sql="SELECT SUBSTRING(question, 1,30) AS question,category,mname,post_date,musername,qid  FROM `questions`  WHERE question LIKE '%".$search."%'";
        	...
        	'<div class="col-lg-10 col-lg-push-1 col-md-10 col-md-push-1 col-sm-12 col-xs-12" style="margin-top: 20px;" >
						<div class="thumbnail" style="background-color: #1A1A1A ; border: 1px #930002 solid">
						  <div class="caption">
							...
							<p>Posted By Username : <span>'.$row["musername"].'</span>
