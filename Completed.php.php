...
session_start();
include 'dbh.php'; if(isset($_SESSION['username'])){
							   	...
							   	while($row = $result->fetch_assoc())
							   {
								   ...
								   $username=$row['username'];   
									...
									$sql="INSERT INTO questions(question,category,mid,mname, 	musername)  
									VALUES('$questions','$category','$mid','$mname','$username')";
							...
							echo'<div class="col-lg-12 col-md-12 col-sm-12 col-xs-12 heading text-center" >
      	         
      	         <br>
      	         <label style="font-size: 80px; color: white ; font-weight: bolder " class="glyphicon glyphicon-ok"></label>
      	         <br>
      	          <label style="font-size: 50px; color: white ; font-weight: bolder ">Question Posted Successfully</label>
      	          <br>
      	          ...
      	          <a href="Questions.php"  class="col-lg-12 col-md-12 col-sm-12 col-xs-12  text-center a"><spam class="glyphicon glyphicon-question-sign" ></spam> View Question</a> ';
